...
It's best to always use the most recent release, unless you're trying to reproduce an old analysis
...
parameters (see `-r` [command docs](https://www.nextflow.io/docs/latest/sharing.html#handling-revisions)).
...
a run command (see [nextflow docs](https://www.nextflow.io/docs/latest/cli.html#commands)):
