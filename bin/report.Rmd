...
```{r, echo=FALSE}
# logo
htmltools::img(src = knitr::image_uri("PGS_Logo.png"),
               alt = 'logo', 
...
## Scoring file metadata {.tabset .tabset-fade}

<div class="alert alert-info", role="alert">
<p>Additional <a href="https://pgscatalog.github.io/pgsc_calc/explanation/output.html">documentation is available</a> that explains some of the terms used this report in more detail</p>
</div>
...
log %>%
  ...
  tidyr::unite("Publication", c(Publication, pgp_id), sep = ";<br>") %>%
...
log %>%
  ...
  group_by(sampleset, accession) %>%
  count(match_type, ambiguous, is_multiallelic) %>%
...
<div class="alert alert-info", role="alert">
<p>All scores can also be found in "aggregated_scores.txt.gz", in the results folder 
output by the pipeline</p>
</div>