...
tribble(
  ~'reference', ~'N (matched)', ~'N variants in panel', ~'% matched',
  {params$reference_panel_name}, intersect_stats[1], intersect_stats[1]+intersect_stats[2], intersect_stats[1] / (intersect_stats[1] + intersect_stats[2])) %>% DT::datatable()
```
